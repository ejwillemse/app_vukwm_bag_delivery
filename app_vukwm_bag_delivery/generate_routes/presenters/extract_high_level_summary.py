...
def extract_unscheduled_route_stops():
    ...
    unscheduled_stops = (
        unscheduled_stops[["route_id", "stop_id"]]
        .rename(columns={"route_id": "Vehicle id", "stop_id": "Site Bk"})
        .merge(unscheduled_stops_full, how="left")
    )
